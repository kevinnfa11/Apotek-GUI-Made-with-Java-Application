 ...
 * @author USER
 */
public class Kapsul3Controller implements Initializable {
    
    
        public void back(ActionEvent event) throws IOException {               
        FXMLLoader loader = new  FXMLLoader(ApotekGUI.class.getResource("/ApotekGUI/Kapsul/Kapsul2.fxml"));
